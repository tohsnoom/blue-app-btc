...
# Phore
DEFINES   += COIN_P2PKH_VERSION=55 COIN_P2SH_VERSION=13 COIN_FAMILY=1 COIN_COINID=\"DarkNet\" COIN_COINID_HEADER=\"PHORE\" COIN_COLOR_HDR=0x00D188 COIN_COLOR_DB=0x90DFC4 COIN_COINID_NAME=\"Phore\" COIN_COINID_SHORT=\"PHR\" COIN_KIND=COIN_KIND_PHORE
APPNAME ="Phore"
APP_LOAD_PARAMS += --path $(APP_PATH)
else ifeq ($(COIN),pivx)
# PivX
...
$(error Unsupported COIN - use bitcoin_testnet, bitcoin, bitcoin_cash, bitcoin_gold, litecoin, dogecoin, dash, zcash, komodo, stratis, peercoin, posw, phore, pivx, viacoin, vertcoin, stealthcoin, digibyte, qtum, hcash) 
endif
endif
